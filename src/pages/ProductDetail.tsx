        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              <div>
                <Badge className={product.inStock ? "stock-badge-available" : "stock-badge-unavailable"}>
                  {product.inStock ? "In Stock" : "Out of Stock"}
                </Badge>
                <h1 className="font-heading text-2xl md:text-3xl font-bold text-foreground mt-4">
                  {product.name}
                </h1>
                <p className="text-xl text-primary font-semibold mt-2">{product.strength}</p>
              ...
              <div className="pharma-card p-6 space-y-4">
                <h3 className="font-heading font-semibold text-foreground">Product Details</h3>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">{product.strength}</p>
                  </div>
                  <div>
              ...
              <div className="pharma-card p-6">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  High-quality {product.name} manufactured under WHO-GMP certified facilities. 
                  Suitable for hospital and clinical use. Each batch undergoes rigorous quality control 
